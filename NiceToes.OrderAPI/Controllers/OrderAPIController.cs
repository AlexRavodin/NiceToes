...
namespace NiceToes.OrderAPI.Controllers
{
    [Route("api/order")]
    [ApiController]
            ...
            try
            {
                ...
                foreach (var item in stripeRequestDto.OrderHeader.OrderDetails)
                {
                    var sessionLineItem = new SessionLineItemOptions
                    {
                        ...
                        {
                            UnitAmount = (long)(item.Price * 100) / 3, // $20.99 -> 2099
                            Currency = "usd",
